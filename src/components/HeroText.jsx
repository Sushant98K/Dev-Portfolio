...
const HeroText = () => {
    const words = ["Secure", "Fast", "Responsive", "Modern", "User-Friendly", "Scalable", "Cost-Effective"];
    const variants = {
        hidden: {
            opacity: 0,
            x: -50
  ...
  return (
    ...
    {/* Desktop View */}
    <div className="flex-col hidden md:flex col-auto">
        <motion.h1 className="text-4xl font-medium" variants={variants} initial="hidden" animate="visible" transition={{delay: 1}}>Hi, I'm Sushant</motion.h1>
        <div className="flex flex-col items-start">
            <motion.p className="text-5xl font-medium text-neutral-300" variants={variants} initial="hidden" animate="visible" transition={{delay: 1.2}}>A Developer<br />With a passion for crafting</motion.p>
    ...
    {/* Mobile View */}
        <div className="flex flex-col space-y-6 md:hidden">
            <motion.p className="text-3xl font-medium" variants={variants} initial="hidden" animate="visible" transition={{delay: 1}}>HI, I'm Sushant</motion.p>
            <div className="">
